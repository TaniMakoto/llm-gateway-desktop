...
//!
//! This module is used when the Codex client talks to LLM Gateway Desktop through the
...
pub(crate) fn response_id_from_chat_id(id: Option<&str>) -> String {
    let id = id.unwrap_or("llmgateway");
...
mod tests {
    ...
    // Regression coverage for strict upstreams rejecting tool_choice without tools.
