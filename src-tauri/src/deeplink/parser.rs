...
//!
//! Parses llmgateway:// URLs into DeepLinkImportRequest structures.
...
/// Parse a llmgateway:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// llmgateway://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "llmgateway" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'llmgateway', got '{scheme}'"
        )));
    }
