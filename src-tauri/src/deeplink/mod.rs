//! Deep link import functionality for LLM Gateway Desktop
//!
//! This module implements the llmgateway:// protocol for importing configurations
...
///
/// Represents a parsed llmgateway:// URL ready for processing.
