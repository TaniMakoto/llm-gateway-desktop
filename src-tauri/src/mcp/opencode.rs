...
//!
//! 本模块处理 LLM Gateway Desktop 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | LLM Gateway Desktop 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: LLM Gateway Desktop → OpenCode
// ============================================================================

/// Convert LLM Gateway Desktop unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → LLM Gateway Desktop
// ============================================================================

/// Convert OpenCode format to LLM Gateway Desktop unified format
///
/// Conversion rules:
