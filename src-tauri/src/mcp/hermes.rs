...
//!
//! Handles conversion between LLM Gateway Desktop unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | LLM Gateway Desktop unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// LLM Gateway Desktop has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: LLM Gateway Desktop -> Hermes
// ============================================================================

/// Convert LLM Gateway Desktop unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> LLM Gateway Desktop
// ============================================================================

/// Convert Hermes format to LLM Gateway Desktop unified format
///
/// Conversion rules:
...
/// `existing` — this prevents LLM Gateway Desktop from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive LLM Gateway Desktop round-trip"
        );
    }
